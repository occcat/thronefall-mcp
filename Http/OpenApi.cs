...
public static class OpenApi
{
    ...
    static Dictionary<string, object> Paths()
    {
        return new Dictionary<string, object>
        {
            ...
            ["/night/policy"] = Post("SetNightPolicy", "Set and immediately run human | afk_castle | scripted_posts. Default human does not touch combat. Legal in day/night."),
            ...
            ["/loadout/select"] = Post("SelectLoadout", "TrySelectEquippableForLoadout. Legal in level_select."),
            ["/level/start"] = Post("StartLevel", "LevelInteractor.InteractionBegin + PlayButtonPressed. Legal in level_select. Does not LoadScene."),
