...
public static class King
{
    ...
    public static void Reset()
    {
        ...
        RememberPolicy(string.IsNullOrEmpty(PluginConfig.DefaultNightPolicy)
            ? NightPolicies.Human
    ...
    static void RememberPolicy(string parsed)
    {
        CurrentPolicy = parsed;
        var facade = GameFacade.Current;
        if (facade != null)
            facade.NightPolicy = parsed;
    }
